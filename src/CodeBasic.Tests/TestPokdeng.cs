...
namespace CodeBasic.Tests
{
    public class TestPokdeng
    {
        ...
        [Theory(DisplayName = "เจ้ามือชนะด้วยป๊อก 9")]
        [InlineData(100, 7, 2, Club, Club, 1, 1, Club, Club, 1000, 900)]
        [InlineData(100, 8, 1, Club, Club, 3, 1, Club, Club, 1000, 900)]
        [InlineData(100, 5, 4, Club, Club, 2, 3, Club, Club, 1000, 900)]
        ...
        //  [Theory(DisplayName = "เจ้ามือชนะด้วยป๊อก 8")]
        // [InlineData(100, 7, 1, Club, Club, 1, 1, Club, Club, 1000, 1100)]
        // [InlineData(100, 6, 2, Club, Club, 3, 1, Club, Club, 1000, 1100)]
        // [InlineData(100, 5, 3, Club, Club, 2, 3, Club, Club, 1000, 1100)]
