...
namespace CodeBasic.Tests
{
    public class PokdengTest
    {
        ...
        [InlineData(PokdengInfo.PlayerResult.Set, 8, 9, 10, PokdengInfo.Symbol.Heart, PokdengInfo.Symbol.Diamond, PokdengInfo.Symbol.Spade)]
        ...
        public void GetRewardTypeTest(PokdengInfo.PlayerResult expected, int p1CardNo1, int p1CardNo2, int p1CardNo3, string p1CardSymbol1, string p1CardSymbol2, string p1CardSymbol3)
        {
            var player = new Pokdeng();
